...
export async function GET() {
  ...
  try {
    // let's pretend this came from a headless CMS, notice
    // how we fake heredoc without needing a trim

    // cspell:disable
    response.payload = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam odio mi, \
