 ...
 * ran on the server's or client's execution context.
 * @returns {boolean} A flag to indicate if code is being executed on the server or not.
 */
...
export const getBaseUrl = () => {
  // keep in mind that isServer is not hoisted
  if (isServer()) {
